...
function validate_already_running () {
    ...
    check_component_running "seafdav" "seafdav --log-file"
    check_component_running "seafdav" "seafdav runfcgi --log-file"
}
...
function stop_seafile_server () {
    ...
    pkill -f "seafdav --log-file"
    pkill -f "seafdav runcfgi --log-file"
    return 0
}
